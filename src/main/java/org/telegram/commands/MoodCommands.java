    ...
    public void executeWhiteListedUser(AbsSender absSender, User user, Chat chat, String[] arguments) {
        try {
            if (arguments != null && arguments.length > 0) {
                ...
                System.out.println(String.format("/mood %s from %s", entry, user.getUserName()));
                ...
                sendMessage(chat, "Provide at least a value between 1 and 10, e.g. /vote 8");
            }
